...
import nbclassic.nbextensions as nbextensions
...
def test_help_output():
    check_help_all_output('nbclassic.bundler.bundlerextensions')
    check_help_all_output('nbclassic.bundler.bundlerextensions', ['enable'])
    check_help_all_output('nbclassic.bundler.bundlerextensions', ['disable'])
...
class TestBundlerExtensionCLI(unittest.TestCase):
    ...
    def test_enable(self):
        ...
        enable_bundler_python('nbclassic.bundler.zip_bundler')
    ...
    def test_disable(self):
        ...
        self.test_enable()
        disable_bundler_python('nbclassic.bundler.zip_bundler')
